...
define('BASEPATH'     , IS_LOCAL ? '/PruebaDev/' : '/'); // Debe ser cambiada a la ruta de tu proyecto en producción y desarrollo
define('IS_DEMO'      , false);

// Set para conexión en producción o servidor real
define('DB_ENGINE'    , 'mysql');
define('DB_HOST'      , 'localhost');
define('DB_NAME'      , 'db_prueba_dev');
define('DB_USER'      , 'root'); 
define('DB_PASS'      , '');
