...
class Bee {
   ...
   * @var string
   */
  private $framework    = 'Todo Hidraulicos Framework'; // Ahora este solo será el nombre idenficador del framework y no el nombre del sistema como tal
  private $version      = '1.0.0';         // versión actual del framework y no del sistema en desarrollo, la versión del sistema deberá ser actualizada directamente en bee_config.php
  private $lng          = 'es';
  private $uri          = [];
